...
def marks_to_grade(marks):
    """important to assign letter grades for marks scored by students"""
    if marks >= 85:
        return 'A'
    elif marks >= 70:
        return 'B'
...
def main():
    ...
    while True:         #always show menu until user exit(it will break loop)
        ...
        if choice == '1': 
            ...
            export_report()
        elif choice == '7': #to exit cutely and gracefully by adding more fun rather than just plain exit
